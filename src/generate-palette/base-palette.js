const { defaultTo, splitEvery } = require('rambdax')
...
function buildColors(modeInput) {
  const missingScopesRaw = getMissingScopesList()
  const missingScopes = splitEvery(
    Math.floor(missingScopesRaw.length / 5),
    missingScopesRaw,
  )[modeInput]
...
const COLOR_2 = [...buildColors(2), 'source.css', 'source.json']
