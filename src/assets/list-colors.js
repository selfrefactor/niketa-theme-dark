exports.listColors = {
  ...
  'list.activeSelectionBackground': '#5557',
  // Right click on file in file explorer, this is foreground on hover
  'list.activeSelectionForeground': '#42C6FFcc',
  // on drag and drop of folders
  'list.dropBackground': '#db82d677',
  // when select theme, this is active theme background
  'list.focusBackground': '#6d50a1',
  'list.highlightForeground': '#a8a',
  // when file is selected and then it turns inactive,
  // visible in autocomplete, in suggest, change of theme, git commit screen
  'list.hoverBackground': '#777777aa',
  ...
  'list.inactiveSelectionBackground': '#4d0e0b',
