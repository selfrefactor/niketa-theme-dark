const { allThemes: allThemesLight } = require('./themes-colors-light.js')
const { pipe, replaceItemAtIndex, uniq, map, flatten, sortBy, uniqBy, groupBy } = require('rambda')
...
function generateResult({ index, allThemes, colorsCandidates }) {
